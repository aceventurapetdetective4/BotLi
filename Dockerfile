...
RUN wget -U "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.93 Safari/537.36" --no-check-certificate "https://chess.massimilianogoi.com/download/tablebases/Syzygy3-4-5/" -O 3-4-5.7z
RUN 7zr e 3-4-5.7z && rm 3-4-5.7z
